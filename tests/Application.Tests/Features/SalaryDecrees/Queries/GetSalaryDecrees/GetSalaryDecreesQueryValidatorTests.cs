...
public class GetSalaryDecreesQueryValidatorTests
{
    private readonly GetSalaryDecreesQueryValidator _validator = new();
    ...
    private static GetSalaryDecreesQuery CreateValidQuery(
        Guid? userId = null,
    ...
    {
        var query = CreateValidQuery(status: (SalaryDecreeStatus)999);
