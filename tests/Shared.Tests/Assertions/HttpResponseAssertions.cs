...
public static class HttpResponseAssertions
{
    ...
    public static async Task<Dictionary<string, string[]>> ShouldBeFailure<TResponse>(this HttpResponseMessage response,
        BadResultType? expectedBadResultType = null)
    {
        response.StatusCode.Should().Be(HttpStatusCode.OK);
        ...
        return body.Errors!.ToDictionary();
    }
