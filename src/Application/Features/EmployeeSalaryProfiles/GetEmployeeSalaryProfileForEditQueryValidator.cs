...
public class GetEmployeeSalaryProfileForEditQueryValidator : AbstractValidator<GetEmployeeSalaryProfileForEditQuery>
{
    public GetEmployeeSalaryProfileForEditQueryValidator()
    {
        RuleFor(x => x.UserId)
